...
public enum ResultEnum {
    ...
    STUDY_DATA_IS_EXIST(2005,"学习资料不能重复"),
    STUDENTNUM_IS_EXIST(2006,"学号已存在"),
    EREPOSITORY_ID_IS_EXIST(2010,"题库id重复"),
    EREPOSITORY_ID_NOT_EXIST(2011,"题库id不存在"),
    EREPOSITORY_DATA_NOT_EXIST(2012,"题库数据不存在"),
    EREPOSITORY_DATA_IS_EXIST(2013,"题库数据不能重复"),
    /*
    /*
        第三方相关（3xxx）
     */
