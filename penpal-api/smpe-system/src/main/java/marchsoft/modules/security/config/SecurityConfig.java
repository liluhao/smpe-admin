...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public DaoAuthenticationProvider authenticationProvider(@Qualifier("passwordEncoder") PasswordEncoder passEncoder) throws Exception {
    ...
    @Bean
    public ProviderManager providerManager(@Qualifier("authenticationProvider") AuthenticationProvider provider){
